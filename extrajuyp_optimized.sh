...
# Enhanced RL packages
pip install --no-cache-dir \
    "gymnasium[classic-control,mujoco]" shimmy sb3-contrib stable-baselines3 \
...
pip install --no-cache-dir \
    ...
    newspaper3k "unstructured[pdf,docx,pptx,md,html,image]" scrapy parsel \
    itemadapter itemloaders splash
...
test_packages = [
    ...
    'selenium', 'apache_airflow', 'dgl', 'napari'
]
